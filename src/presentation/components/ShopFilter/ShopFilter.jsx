    ...
    return (
        <div id="shop-filter">
            <div className="filter-left">
                ...
                </svg><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" style={{ marginRight: "30px" }}>
                ...
                <div className="filter-detail">Showing {skip + 1}-{Math.min(skip + limit, total)} of {total} results</div>
            </div>
            <div className="filter-right">
                <>
                    <div className="field-title">Show</div>
                    <div className="dropdown">
                        <div className="field-border" style={{ padding: "13px 0px", textAlign: "center", width: "55px", marginRight: "30px" }}>
                            {limit}
                        </div>
                        <div className="dropdown-content">
                            <div className="dropdown-item" onClick={() => handleClick(8)}>8</div>
                            <div className="dropdown-item" onClick={() => handleClick(16)}>16</div>
                            <div className="dropdown-item" onClick={() => handleClick(32)}>32</div>
                        </div>
                    </div>
