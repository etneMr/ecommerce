...
export default function Blog() {
    ...
    return (<>
        ...
        <div style={{ marginBottom: "54px" }}>
            ...
            <PageNavigation length={Math.ceil(3)} selected={1} />
        </div>
        <Footer />
    </>
    );
...
function CategoryBlogComponent() {
    return (<>
...
function ListPostsComponent() {
    const post = {
        img: "https://smartloyalty.vn/wp-content/uploads/2023/06/CRM_5-2048x1536.png",
    ...
    return (< >
        <ul className="list-posts">
            <li className="list-posts-item">
                <img className="post-image" src={post.img} alt={post.tag} />
                <div className="extra-detail">
                    ...
                    <IconTitle child={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
